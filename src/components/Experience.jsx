                        ...
                        <div className = 'educationProjects'>
                            ...
                            <div className="technologies">
                                <div className="technologyContainer">
                                    <img className = "logo" src="./public/java.png" alt="java" /> 
                                    <p>Java</p>
                                </div>
                                <div className="technologyContainer">
                                    <img className = "logo smallLogo" src="./public/eclipse.svg" alt="eclipse" />
                                    <p>Eclipse IDE</p>
                                </div>
                                <div className="technologyContainer">
                                    <img className = "logo smallLogo" src="./public/logo-data-structure.png" alt="data structure and algorithm" />
